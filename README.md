About apache-airflow-providers-docker-feedstock
===============================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/apache-airflow-providers-docker-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/apache-airflow-providers-docker-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add apache-airflow-providers-docker
# for installing globally
pixi global install apache-airflow-providers-docker
```
...
It is possible to list all of the versions of `apache-airflow-providers-docker` available on your platform:
...
```
pixi search apache-airflow-providers-docker --channel conda-forge
```
